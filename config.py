...
API_ID = int(os.environ.get("API_ID", "28022215"))
API_HASH = os.environ.get("API_HASH", "c7431232d6f69436238937d11806389a")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "5933201329:AAGlqEuetmv6FsVR9KOczdiQQFiMl6Zx_Js")
...
CHANNEL_ID = list(int(i.strip()) for i in os.environ.get("CHANNEL_ID").split("-1001750259696")) if os.environ.get("CHANNEL_ID") else []
FORWARD_MESSAGE = is_enabled((os.environ.get('FORWARD_MESSAGE', "True")), True)
SOURCE_CODE = os.environ.get("SOURCE_CODE", "https://github.com/WebSubas/Converter")
USERNAME = os.environ.get("USERNAME", "Filmy_Official")
